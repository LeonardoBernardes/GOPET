  ...
  <body>
    ...
    <!--div class="container">
      <div class="card-deck mb-3 text-center">
        <div class="card mb-4 box-shadow">
          ...
          <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
              <li>Postagem de animais</li>
              <li>Visualização de animais</li>
              <li>&nbsp;</li>
              <li>&nbsp;</li>
            </ul>
        ...
        <div class="card mb-4 box-shadow">
          <div class="card-header">
            <h4 class="my-0 font-weight-normal">Super-Pro</h4>
          </div>
          <div class="card-body">
